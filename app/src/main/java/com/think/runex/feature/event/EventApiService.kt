...
interface EventApiService {
    ...
    fun getEventListAsync(@Path(ApiUrl.KEY_VERSION) version: String = ApiUrl.getApiVersion()): Deferred<Result<List<Event>>>
    ...
    fun getEventListByStatusAsync(
            ...
            @Header(ApiUrl.KEY_AUTH) token: String = TokenManager.accessToken()): Deferred<Result<List<Event>>>
    ...
    fun getProductListInEventAsync(
            @Path("eventId") eventId: String,
            @Path(ApiUrl.KEY_VERSION) version: String = ApiUrl.getApiVersion(),
            @Header(ApiUrl.KEY_AUTH) token: String = TokenManager.accessToken()): Deferred<Result<List<Product>>>
}