...
import com.think.runex.feature.event.register.ShirtsDialog
...
class FillOutUserInfoFragment : BaseScreen(), DatePickerDialog.OnDateSetListener,
    ...
    private fun isDataValid(): Boolean {
        ...
        if (viewModel.eventDetail.value?.shirts?.isNotEmpty() == true && viewModel.ticketData.shirt == null) {
    ...
    private fun createUserData() = UserEventRegistrationBody().apply {
