...
public class GetMyActiveRegisteredEventService extends xRequest {
    /**
     * Main variables
     */
    private final String ct = "GetMyActiveRegisteredEventService->";

    public GetMyActiveRegisteredEventService(Activity activity, onNetworkCallback networkCallback) {
    ...
    public void doIt() {
        ...
        //--> props
        props.setUrl(APIs.MY_ACTIVE_REGISTERED_EVENT.VAL);
